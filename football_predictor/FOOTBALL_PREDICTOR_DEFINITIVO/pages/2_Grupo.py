...
if len(names) < 4:
    st.warning("Necesitas al menos 4 equipos cargados para simular un grupo. Ve a 'Actualizar Datos'.")
    st.stop()
...
default_positions = [0, 6, 10, 14]
defaults = [names[i] if i < len(names) else names[0] for i in default_positions]
